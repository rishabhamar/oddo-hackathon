...
- giv response as same language as users

dont give no on every text or every response only give it on majjor thinks only give indian helpline numbers. If you're experiencing a mental health crisis or 
...
model = genai.GenerativeModel(
    ...
    model_name="gemini-1.5-pro",  # Changed to pro for image capabilities
...
def chat():
    try:
        ...
        print(f"Image included: {bool(image_data)}")
